...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "Priya") ||(event.body.toLowerCase() == "Priyu")) {
     return api.sendMessage("Priya sirf Rehan ki hai bsdk, usko mention mat kr", threadID);
   };
  
   if ((event.body.toLowerCase() == "hi") || (eventody.toLowerCase() == "hello") ||(event.body.toLowerCase() == "hlw") || (evt.body.toLowerCase() == "helo")) {
     return api.sendMessage("Hello, Hi,ye bye. Ye sab ke alawa kuch bolna nhi ata Kya tujhe", threadID);
   };

 if ((event.body.toLowerCase() == "bc") || (event.body.toLowerCase() == "bc) {
     return api.sendMessage("Ye Bc Kya HoTa Hai 🤔 ", thadID);
   };

   if ((event.body.toLowerCase() == "lol") || vent.body.toLowerCase() == "lol bot")) {
     return api.senessage("Khud ko Kya LeGend Samjhte Ho 😂", threadID);
   };
  if ((event.body.toLowerCase() == "morning") || (event.bodyoLowerCase() == "good morning")) {
     return api.sendMessa("Ꮆɵɵɗ Ɱ❍ɽƞɪɪƞɠ Ɛⱱɛɽɣ❍ƞɛ🌅, Ƭɽɣ ꌗɵɱɛ Cɵffɛɛ ❍ɽ Ƭɛɑ Ƭ❍ Ꮗɑҡɛ U✨💫", threadID);
   };

   if ((event.body.toLowerCase() == nyone") || (event.body.toLowerCase() == "any")) {
     returapi.sendMessage("Main Hun Naw Jaaneman ❤️", threadID);
   };   if ((event.body.toLowerCase() == "priyansh") || (event.bo.toLowerCase() == "priyansh rajput") || (event.body.toLowerCe() == "priyansh") || (event.body.toLowerCase() == "prince"){
     return api.sendMessage( "Busy HoGa Work Me Main t0o HuNaw 😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner"){
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞𝕻𝖗𝖎𝖞𝖆𝖓𝖘𝖍 𝕽𝖆𝖏𝖕𝖚𝖙☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ℙ𝕚𝕪𝕒𝕟𝕤𝕙🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ www.facebook.com/priyanshu.rajput.official\n👋For Any Kind Of Helpontact On Telegram  Username 👉 @Priyanshrajput😇", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banayaon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("Priyansh  ❤️ My Crea He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh h Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "t admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is Pyansh. He Gives his name Priyansh everywhare", threadID);
   };

   if ((event.body.toLowCase() == "shadi karoge") || (event.body.toLowerCase() == "mujhse shadi karoge?")) {
   return api.sendMessage("hanji, karunga lekin baccha. apke pet m hoga. manjur h?"threadID);
   };

   if ((event.body.toLowerCase() == "chup")| (event.body.toLowerCase() == "stop") || (event.body.toLowerse() == "chup ho ja") || (event.body.toLowerCase() == "chup k")) {
     return api.sendMessage("Nhi rahunga. 😼 Mujhe BolnH. Tumhe Koi Haq nhi Mujhe Chup Karane ka. Mera Zuban. M Bolunga", threadID);
   };

   if ((event.by.toLowerCase() == "bts") || (event.body.toLowerCase() == "btc")) {
     return api.sendMessage("Tu Btc. Bhos DK", threadID);
   };

   if ((event.body.toLowerCase() == "mak se bakchodi") || (event.body.toLowerCase() == "malik se backchodi") ||event.body.toLowerCase() == "malkin se bakchodi") || (event.body.toLowerse() == "malkin se backchodi")) {
     return api.sendMessage("srry malimaaf kr do ab nhi kruga 🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "gand") || (event.body.toLowerCas) == "gandu") || (event.body.toLowerCase() == "lund") || (event.body.toLowerCase() == "land"))      return api.sendMessage("Gand m jyada khujli h toh banana 🍌 under le le. :))))", threadID)   };

   if ((event.body.toLowerCase() == "chumma de") || (event.body.toLowerCase() == "kiss me"))
     return api.sendMessage("️Kis khushi me, Me sirf Apni gf ko kiss karta hu", threadID);
   };

   if ((event.body.toLowerCase() == "nice") || (event.body.toLowerCase() == "thank you") || (evt.body.toLowerCase() == "thank you bot") || (event.body.toLowerCase() == "thank you maliha")) {
  ...
  if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
     return api.sendMessage("️️Chutiya Jaisi Sakal Kyu bana rahe ho🙈", threadID);
   };
